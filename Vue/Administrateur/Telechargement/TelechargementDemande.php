    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6">
                ...
                <form action="../../../Controlleur/TelechargementDm.php" method="post">
            ...
            <div class="col-md-6">
                ...
                <div class="text-end"><a href="../../../Excel/Demande.php" class="btn btn-primary" role="button" style="border-radius: 19px;">Télécharger</a></div></form><hr></div>
                <hr>
            </div>
        </div>
    </div>
