...
<body style="filter: blur(0px);">
    <section class="login-clean" style="filter: blur(0px);">
        <form method="post" action="../../Controlleur/Authentification/AutAdmin.php"style="border-width: 0px;border-radius: 60px;">
            <h2 class="visually-hidden">Login Form</h2><a class="forgot" href="#"><img class="img-fluid" src="assets/img/husband.gif" style="width: 30px;height: 30px;"name="">Administrateur</a>
