...
<body style="filter: blur(0px);">
    <section class="login-clean" style="filter: blur(0px);">
        <form method="post" action ="../../Controlleur/AdminControlleur.php"style="border-width: 0px;border-radius: 60px;">
            ...
            <div class="mb-3"></div>
            <div class="mb-3"><input class="form-control" type="email" data-bss-hover-animate="pulse" placeholder="Email" style="border-radius: 40px;"name="ad_email"></div>
