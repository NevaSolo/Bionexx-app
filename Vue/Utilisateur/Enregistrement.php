...
<body style="filter: blur(0px);">
    ...
    <form action="../../Controlleur/DemandeurControlleur.php" method="post">
        <form action="" method="post" style="border-width: 0px;border-radius: 60px;">
            ...
            <div class="mb-3"><input class="form-control" type="text" data-bss-hover-animate="pulse" placeholder="Departement" style="border-radius: 40px;"name="dem_dep"></div>
            <div class="mb-3"><input class="form-control" type="email" data-bss-hover-animate="pulse" placeholder="Email" style="border-radius: 40px;"name="dem_email"></div>
