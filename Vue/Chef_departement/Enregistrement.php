...
<body style="filter: blur(0px);">
    <section class="login-clean" style="filter: blur(0px);">
        <form method="post" action ="../../Controlleur/ChefDepartControlleur.php"style="border-width: 0px;border-radius: 60px;">
            ...
            <div class="mb-3"><input class="form-control" type="text" data-bss-hover-animate="pulse" placeholder="Departement" style="border-radius: 40px;"name="chef_dep"></div>
            <div class="mb-3"><input class="form-control" type="email" data-bss-hover-animate="pulse" placeholder="Email" style="border-radius: 40px;"name="chef_email"></div>
