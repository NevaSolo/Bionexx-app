...
<head>
    ...
    <title>Login chef de departementError</title>
...
<body style="filter: blur(0px);">
    <section class="login-clean" style="filter: blur(0px);">
        <form method="post" action="../../Controlleur/Authentification/AutChef.php" style="border-width: 0px;border-radius: 60px;">
            ...
            <div class="illustration"><img class="img-fluid" src="assets/img/Bionexx_006.jpg"></div><a class="forgot" href="#"><i class="icon-close"></i>Les données sont incorrecte</a>
